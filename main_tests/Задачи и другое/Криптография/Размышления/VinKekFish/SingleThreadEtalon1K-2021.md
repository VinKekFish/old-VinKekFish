...
4.1. Прирастить младшее слово tweak на 1253539379. Прирастить старшее слово tweak на длину ОВИ + общую длину ключа. Больше tweak никак не изменяется (количество вводимых байтов и режим не вводятся).
...
tweak приращается на 1253539379 на каждый шаг шифрования, при это больше ввода туда нет (количество вводимых байтов и режим не вводятся)
...
Ввод нулей происходит стандартно со стандартным изменением tweak
